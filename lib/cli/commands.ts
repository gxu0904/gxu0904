...
export const contactCommand: CommandHandler = () => {
  return {
    lines: [
      ...
      { type: 'link', content: `  Twitter: ${person.socials.twitter}` },
      { type: 'text', content: '' },
  ...
  if (filename === 'secret.txt') {
    return {
      lines: [
        ...
        { type: 'text', content: '' },
        { type: 'text', content: 'Fun fact: I built my first website when I was 12 years old.' },
        { type: 'text', content: 'It was a Harry Potter fan site with Comic Sans and' },
